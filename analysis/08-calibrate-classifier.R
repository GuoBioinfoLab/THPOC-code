...
# @DESCRIPTION: 08-calibrate-classifier.R
...
sr.hc.bam.task <- readr::read_rds(file = "data/rda/sr.hc.bam.task.rds.gz")
...
save.image(file = "data/rda/08-calibrate-classifier.rda")
